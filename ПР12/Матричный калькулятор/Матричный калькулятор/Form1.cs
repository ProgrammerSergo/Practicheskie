        ...
        private void NumericColumns_A_ValueChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                catch (ArgumentOutOfRangeException)
                {
                    ...
                    MessageBox.Show("Неправильно указано количество столбцов,выберите нужное количество!",
                    "Ошибочка",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Warning);
        ...
        private void NumericRows_A_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (checkBoxFit.Checked == true)
            {
                ...
                catch (ArgumentOutOfRangeException)
                {
                    ...
                    MessageBox.Show("Неправильно указано количество столбцов, подберите нужное количество столбцов!",
                    "Ошибочка",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Warning);
                    dataGridMatrix_A.RowCount = 1;
